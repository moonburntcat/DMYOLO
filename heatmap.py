...
def get_params():
    params = {
        'weight': 'gefan1222.pt',  # 训练出来的权重文件
        'cfg': 'ultralytics/cfg/models/v10/yolov10s-C2f_MSDA+dysample.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'dataset/bvn/images/val/healthy4.png', 'result_healthy4')  # 第一个是检测的文件, 第二个是保存的路径